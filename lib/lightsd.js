...
(function(){
  var airport, lock, MicroDB, spawn, settings, version, spit, cbify, air, turnLock, turn, lightsDb, listLights, delLight, delLightByName, addLight, turnLight, scheduleDb, listSchedule, delSchedule, addSchedule, addScheduleLight, scheduleRun, scheduleNext, scheduleTimeout, execSchedule, slice$ = [].slice;
